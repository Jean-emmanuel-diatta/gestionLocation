        ...
        <div class="card">
            <div class="card-header bg-gradient-primary d-flex align-items-center">
                ...
                <div class="card-tools d-flex align-items-center">
                    <a class="btn btn-link text-white mr-4 d-block" wire:click="toggleShowAddTypeArticleForm"><i class="fas "></i>Nouvel type d'article</a>
                ...
                <table class="table table-head-fixed text-nowrap">
                        ...
                        <tr>
                            <td colspan="2">
                                <input type="text"
                                       ...
                                       wire:model.debounce="newTypeArticleName" />
                    ...
                    @foreach($typearticles as $typearticle)
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-link" wire:click="editTypeArticle({{$typearticle->id}})"><i class="far fa-edit"></i>Editer</button>
                                <button class="btn btn-link" wire:click="showProp({{$typearticle->id}})"><i class="fa fa-list"></i>Proprietes</button>
                                @if(count($typearticle->articles)==0)
                                    <button class="btn btn-link"wire:click="confirmDelete('{{$typearticle->nom}}',{{$typearticle->id}})"><i class="far fa-trash-alt">Supprimer</i></button>
                                @endif
                            </td>
                        </tr>
                    @endforeach
