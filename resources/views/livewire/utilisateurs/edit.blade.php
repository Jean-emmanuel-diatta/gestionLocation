            ...
            <form role="form" wire:submit.prevent="updateUser()">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('editUser.email') is-invalid
                         @enderror" wire:model="editUser.email">
     ...
     <div class="col-md-6">
         <div class="row">
             <div class="col-md-12">
                 <div class="card card-primary">
                     <div class="card-header">
                          <h3 class="card-title"><i class="fas fa-key fa-2x"></i>Reinitialisation de mot de passe</h3>
                     </div>
                           <div class="card-body">
                                <ul>
                                    <li>
                                        <a href="#" class="btn btn-link" wire:click.prevent="confirmPwdReset()">Reinitialiser le mot de passe</a>
             ...
             <div class="col-md-12 mt-4">
                 <div class="card card-primary">
                     <div class="card-header d-flex align-items-center">
                         ...
                         <button class="btn bg-gradient-success" wire:click="updatRoleAndPermissions"><i class="fas fa-check"></i>Appliquer les modifications </button>
                     </div>
                     <div class="card-body">
                        <div id="accordion">
