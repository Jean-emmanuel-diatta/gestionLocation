                ...
                <div class="d-flex">
                    <div class="my-4 bg-gray-light p-3 flex-grow-1">
                        ...
                        <div class="form-group">
                            <label for="">Nom</label>
                            <input type="text" class="form-control" id="" wire:model="addArticle.nom">
                        </div>
                        <div class="form-group">
                            <label for="">Numero de serie</label>
                            <input type="text" class="form-control" id=""wire:model="addArticle.noSerie">
                        </div>
                        <div class="form-group">
                            <label for="">Type</label>
                            <select id=""  class="form-control"wire:model="addArticle.type">
                                <option value=""></option>
                       ...
                       @if($proprietesArticles !=null)
                        ...
                        <div class="my-3 bg-gray-light">
                            @foreach( $proprietesArticles as $propriete)
                                <div class="form-group">
                                    <label for="">{{$propriete->nom}}
                                        @if (!$propriete->estObligatoire) (optionel) @endif
                                    </label>
                                    @php
                                    $field ="addArticle.prop.".$propriete->nom;
                                    @endphp
                                    <input type="text" class="form-control" id=""wire:model="{{$field}}">
                                </div>
                            @endforeach
                        </div>
                        @endif
