            ...
            <div class="card-header bg-gradient-primary d-flex align-items-center">
                ...
                <div class="card-tools d-flex align-items-center">
                    <a href="{{route('admin.gestarticles.articles')}}"
                       ...
                       ><i class="fas fa-long-arrow-alt-left"></i>Retourner
                        vers la liste des articles</a>

                    <a class="btn btn-link btn-db text-white mr-4 d-block"
                       wire:click="nouveauTarif">
                        <i
                            class="fas fa-user"></i> Nouveau tarif</a>
                </div>
            </div>
            ...
            <div class="card-body table-responsive p-0 table-striped">
                ...
                <div class="p-4">
                    <div>
                        <div class="form-group">
                            <select wire:model="newTarif.duree_location_id"
                              ...
                              is-invalid
                                ...
                                <option value="" selected> choisissez une duree de location</option>
                        ...
                        <div class="form-group">
                            <input type="number" class="form-group @error('newTarif.prix') is-invalid @enderror"
                    ...
                    <table class="table table-head-fixed text-nowrap">
                        ...
                        <tbody>
                                @forelse($tarifs as $tarif )
                                    <tr>
                                      <td>{{$loop->index}}</td>
                                      <td>{{ $tarif->dureeLocations}}{{ $tarif->libelle}}</td>
