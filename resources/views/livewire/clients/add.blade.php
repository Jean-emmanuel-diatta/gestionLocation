    ...
    <div class="col-md-6">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-user-plus fa-2x"></i>Formulaire d'Ajout d'un client</h3>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control
                            @error('addClient.sexe') is-invalid @enderror"
                    ...
                    <div class="form-group">
                        ...
                        <input  type="text" class="form-control @error('addClient.nationalite') is-invalid
                         @enderror" wire:model="addClient.nationalite">
                    ...
                    <div class="form-group">
                        <label >Ville</label>
                        <input   type="text" class="form-control @error('addClient.ville') is-invalid
                         @enderror" wire:model="addClient.ville">
                    ...
                    <div class="form-group">
                        <label >Pays</label>
                        <input   type="text" class="form-control @error('addClient.pays') is-invalid
                         @enderror" wire:model="addClient.pays">
                    ...
                    <div class="form-group">
                        <label >Adresse</label>
                        <input  type="text" class="form-control @error('addClient.adresse') is-invalid
                         @enderror" wire:model="addClient.adresse">
